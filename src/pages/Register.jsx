...
//     } catch (err) {
//       // 422 validasi Laravel: tampilkan pesan utama + error field pertama bila ada
//       const data = err.response?.data
//       const firstFieldError = data?.errors ? Object.values(data.errors)[0]?.[0] : null
//       setError(firstFieldError || data?.message || 'Registrasi gagal. Coba lagi.')
//     } finally {
//       setLoading(false)
//     }
//   }
...
//         <p className="muted">Gratis, hanya butuh 1 menit.</p>
