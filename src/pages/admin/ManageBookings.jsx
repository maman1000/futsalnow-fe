...
//   // Jika hasil parse tidak valid (NaN), coba parsing manual dari string YYYY-MM-DD
...
//         <p className="muted">Pantau semua booking dan ubah statusnya.</p>
//       </div>
...
//       ) : bookings.length === 0 ? (
//         <p className="muted">Tidak ada booking yang cocok dengan filter.</p>
//       ) : (
...
//                   <td>{b.payment ? b.payment.method : "—"}</td>
...
//       setError("");
//       try {
//         const params = { page }; // tambahkan page
//         if (status) params.status = status;
//         if (date) params.date = date;
//         const res = await getBookings(params);
//         setBookings(res.data.data || []);
