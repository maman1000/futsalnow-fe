...
//         <p className="page-loading">Memuat dashboard...</p>
//       </div>
//     );
//   if (error)
//     return (
...
//         <p className="muted">Ringkasan performa bisnis.</p>
//       </div>

//       <div className="grid grid-4">
//         <div className="card stat-card">
//           <span className="stat-label">Total Booking</span>
//           <span className="stat-value">{summary.total_bookings}</span>
//         </div>
//         <div className="card stat-card">
...
//           <span className="stat-value">{byStatus.pending ?? 0}</span>
//         </div>
//         <div className="card stat-card">
//           <span className="stat-label">Selesai / Batal</span>
//           <span className="stat-value">
//             {byStatus.completed ?? 0} / {byStatus.canceled ?? 0}
//           </span>
//         </div>
//       </div>
...
//         <p className="muted">Belum ada data booking.</p>
//       ) : (
