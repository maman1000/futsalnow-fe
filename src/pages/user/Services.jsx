...
//   //     try {
//   //       // const res = await getServices({ active: 1 })
//   //       const res = await getServices({ active: 1 });
...
//         <p className="muted">
//           Pilih layanan lalu klik Booking untuk memilih jadwal.
//         </p>
//       </div>

//       {error && <div className="alert alert-error">{error}</div>}
//       {loading ? (
//         <p className="page-loading">Memuat layanan...</p>
//       ) : services.length === 0 ? (
//         <p className="muted">Belum ada layanan aktif.</p>
//       ) : (
