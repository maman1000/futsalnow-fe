...
//       'transfer',
//     )
//     if (method === null) return // user batal
...
//     if (!window.confirm(`Batalkan booking #${booking.id}? Slot jadwal akan dibuka kembali.`)) return
//     setError('')
//     setInfo('')
//     try {
...
//         <h2>Booking Saya</h2>
//         <p className="muted">Riwayat dan status semua booking Anda.</p>
//       </div>
...
//       {loading ? (
//         <p className="page-loading">Memuat booking...</p>
//       ) : bookings.length === 0 ? (
//         <p className="muted">Anda belum punya booking.</p>
//       ) : (
...
//                 <tr key={b.id}>
//                   <td>{b.id}</td>
//                   <td>{b.schedule?.service?.name || '-'}</td>
//                   <td>{formatTanggal(b.booking_date)}</td>
//                   <td>{formatJam(b.schedule?.start_time)}–{formatJam(b.schedule?.end_time)}</td>
...
//                       <button className="btn btn-accent btn-sm" onClick={() => handlePay(b)}>Bayar</button>
//                     )}
//                     {b.status === 'pending' && (
//                       <button className="btn btn-danger btn-sm" onClick={() => handleCancel(b)}>Batal</button>
//                     )}
//                   </td>
//                 </tr>
//               ))}
...
//     try {
//       const res = await getMyBookings();
//       // Ambil array dari response (support pagination atau langsung array)
...
//                 <tr key={b.id}>
//                   <td>{b.id}</td>
//                   <td>{b.service?.name || "-"}</td> {/* ← perbaiki di sini */}
//                   <td>{formatTanggal(b.booking_date)}</td>
//                   <td>
//                     {formatJam(b.start_time)}–{formatJam(b.end_time)}
//                   </td>{" "}
//                   {/* ← akses langsung start_time/end_time */}
//                   <td>
...
//                 {b.status === "pending" && !b.payment && (
//                   <button className="btn btn-pay" onClick={() => handlePay(b)}>
//                     Bayar
//                   </button>
//                 )}
//                 {b.status === "pending" && (
